...
import { ActionColors, Color, CommonColors, Grey, Palette } from "./type";
...
export const warning: Color = {
  ...
  dark: "#B76E00",
  darker: "#7A4100",
  contrastText: grey[800] as string, // Type assertion as string
};
...
export function palette(): Palette {
  return {
    ...
    action: {
      ...base.action,
      active: grey[600] as string, // Type assertion as string
    },
  };
}
